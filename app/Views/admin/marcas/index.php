<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-500">Gestioná las marcas de productos</p>
    </div>

    <a href="<?= BASE_URL ?>/admin/marcas/crear"
...
<?php if (isset($_GET['ok'])): ?>
    <div class="bg-green-50 border border-green-200 text-green-700 rounded-xl px-4 py-3 mb-4 text-sm">
        ...
        $msgs = [
            ...
            'actualizada' => 'Marca actualizada correctamente.',
            'eliminada'   => 'Marca eliminada correctamente.',
        ];
                ...
                <?php while ($m = $marcas->fetch_assoc()): ?>
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-right space-x-3">
                            <a href="<?= BASE_URL ?>/admin/marcas/editar?id=<?php echo $m['id_marca']; ?>"
                               class="text-gray-600 hover:text-gray-900">
                                Editar
                            </a>

                            <?php if ($m['cantidad_productos'] == 0): ?>
                                <a href="<?= BASE_URL ?>/admin/marcas/eliminar?id=<?php echo $m['id_marca']; ?>"
                                   class="text-red-500 hover:text-red-700"
                                   onclick="return confirm('¿Seguro que querés eliminar esta marca?')">
                                    Eliminar
                                </a>
                            <?php else: ?>
